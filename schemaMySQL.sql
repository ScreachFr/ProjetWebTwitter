...
INSERT INTO `gr3_dupas_gaspar`.`sessions` (`key`, `user_id`, `expiration`, `root`) VALUES ('keytata', 2, NULL, 0);
...
START TRANSACTION;
USE `gr3_dupas_gaspar`;
INSERT INTO `gr3_dupas_gaspar`.`friends` (`user1`, `user2`, `date`) VALUES (1, 2, '');
INSERT INTO `gr3_dupas_gaspar`.`friends` (`user1`, `user2`, `date`) VALUES (3, 4, NULL);
INSERT INTO `gr3_dupas_gaspar`.`friends` (`user1`, `user2`, `date`) VALUES (1, 3, NULL);
INSERT INTO `gr3_dupas_gaspar`.`friends` (`user1`, `user2`, `date`) VALUES (1, 4, NULL);
